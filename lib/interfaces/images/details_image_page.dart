      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(onPressed: () {},
            icon: _ActionBtn(icon: Icons.share_outlined)),
          IconButton(onPressed: () {},
            icon: _ActionBtn(icon: Icons.download_outlined)),
                ...
                Image.network(image.imageUrl, fit: BoxFit.cover,
                  loadingBuilder: (_, child, p) => p == null ? child
                      : Container(color: AppColors.green100,
                          child: const Center(child: CircularProgressIndicator(color: AppColors.green600, strokeWidth: 2))),
                ...
                if (isAlerte)
                  Positioned(bottom: 68, left: 16,
                    child: Container(
                      ...
                      decoration: BoxDecoration(color: AppColors.red600.withOpacity(0.9), borderRadius: BorderRadius.circular(10)),
                      child: const Row(children: [
                        Icon(Icons.warning_amber, color: Colors.white, size: 13),
                        SizedBox(width: 5),
                        Text('Anomalie détectée', style: TextStyle(color: Colors.white, fontSize: 11, fontWeight: FontWeight.w500)),
                      ]),
                    ),
                  ),
              ...
              child: Column(
                ...
                children: [
                    ...
                    Container(
                      ...
                      child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        ...
                        Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                          ...
                          const SizedBox(height: 3),
                          const Text('Une vérification terrain est recommandée dans les 24h. Vérifier l\'apport en nutriments et l\'état des racines.',
                  ...
                  AppCard(child: Column(children: [
                    ...
                    _InfoRow(label: 'Zone',        value: image.zone),
                    ...
                    _InfoRow(label: 'Résolution', value: '1920 × 1080 px', isLast: true),
                  ])),
                  ...
                  if (isAlerte || isAnalysee) ...[
                    ...
                    Container(
                      decoration: BoxDecoration(
                        color: isAlerte ? AppColors.red100.withOpacity(0.45) : AppColors.green100.withOpacity(0.45),
                        borderRadius: BorderRadius.circular(13),
                        border: Border.all(
                          color: isAlerte ? AppColors.red600.withOpacity(0.2) : AppColors.green600.withOpacity(0.2),
                        ),
                      ),
                      child: Column(children: [
                        ...
                        Divider(height: 0.5, thickness: 0.5,
                            color: isAlerte ? AppColors.red600.withOpacity(0.15) : AppColors.green600.withOpacity(0.15),
                            indent: 14),
                        _AnalyseRow(
                    ...
                    Container(
                      ...
                      child: Row(children: [
                        ...
                        Text('${image.confiance}%',
                            style: const TextStyle(fontSize: 16, fontWeight: FontWeight.w500, color: AppColors.green700)),
                      ]),
                    ),
                    const SizedBox(height: 14),
                  ],
                  ...
                  if (isAlerte) ...[
                    ...
                    Row(children: [
                      ...
                      const SizedBox(width: 10),
                      Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        const Text('Après — Anomalie', style: TextStyle(fontSize: 11, color: AppColors.red800)),
                        const SizedBox(height: 5),
                        ClipRRect(borderRadius: BorderRadius.circular(10),
                          child: SizedBox(height: 100,
                            child: Stack(fit: StackFit.expand, children: [
                    ...
                    Container(
                      ...
                      child: const Text(
                        'Changement notable entre les deux captures : coloration et densité végétale dégradées sur la zone basse.',
                  ...
                  if (isAlerte) ...[
                    _RecoItem(
                      ...
                      titre: 'Vérifier l\'apport en azote',
                      detail: 'Le jaunissement peut indiquer une carence. Apport foliaire recommandé sous 48h.',
                    ),
                    const SizedBox(height: 8),
                    _RecoItem(
                  ...
                  if (isAlerte) const SizedBox(height: 8),
                  SizedBox(width: double.infinity,
                    child: OutlinedButton.icon(
                      onPressed: () {},
                      icon: const Icon(Icons.camera_alt_outlined, size: 16),
                      label: const Text('Prendre une nouvelle image'),
...
class _StatusBadge extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final color = statut=='alerte' ? AppColors.red600 : statut=='analysee' ? AppColors.green600 : AppColors.textMuted;
    final bg    = statut=='alerte' ? AppColors.red100  : statut=='analysee' ? AppColors.green100  : AppColors.gray50;
    final label = statut=='alerte' ? 'Alerte' : statut=='analysee' ? 'Analysée' : 'Normale';
    return Container(
      padding: const EdgeInsets.symmetric(horizontal: 10, vertical: 5),
...
class _InfoRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Container(
    ...
    decoration: BoxDecoration(border: isLast ? null : const Border(bottom: BorderSide(color: Color(0xFFF0F5EB), width: 0.5))),
...
class _AnalyseRow extends StatelessWidget {
  ...
  final Color color;
  final bool isLast;
  const _AnalyseRow({required this.titre, required this.detail, required this.icon, required this.color, this.isLast = false});
  @override
...
class _RecoItem extends StatelessWidget {
  ...
  const _RecoItem({required this.priorite, required this.prioriteBg, required this.prioriteColor, required this.titre, required this.detail});
  @override
  Widget build(BuildContext context) => Container(
    padding: const EdgeInsets.all(13),
    decoration: BoxDecoration(
    ...
    child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
        ...
        Container(
          ...
          child: Text(priorite, style: TextStyle(fontSize: 10, fontWeight: FontWeight.w500, color: prioriteColor)),
        ),
      ]),
      const SizedBox(height: 5),
      Text(detail, style: const TextStyle(fontSize: 11, color: AppColors.textMuted, height: 1.4)),
