...
class HistoriqueImagesScreen extends StatefulWidget {
  const HistoriqueImagesScreen({super.key});
...
class _HistoriqueImagesScreenState extends State<HistoriqueImagesScreen> {
  ...
  List<CaptureImage> get _filtered {
    var imgs = List<CaptureImage>.from(mockImages);
    if (_filtreZone != 'Toutes')    imgs = imgs.where((i) => i.zone == _filtreZone).toList();
    if (_filtreStatut == 'Alertes')   imgs = imgs.where((i) => i.statut == 'alerte').toList();
    if (_filtreStatut == 'Analysées') imgs = imgs.where((i) => i.statut == 'analysee').toList();
    if (_filtreStatut == 'Normales')  imgs = imgs.where((i) => i.statut == 'normale').toList();
    return imgs;
  }
      ...
      body: Column(
        children: [
          ...
          Container(
            ...
            child: Row(children: [
              _StatChip(icon: Icons.photo_library_outlined, label: '$total captures',
                  bg: AppColors.green100, color: AppColors.green700),
              const SizedBox(width: 8),
              _StatChip(icon: Icons.warning_amber_outlined, label: '$alertes alertes',
              ...
              GestureDetector(
                ...
                child: Container(
                  ...
                  child: Row(children: [
                    const Icon(Icons.filter_list, color: AppColors.green700, size: 14),
                    const SizedBox(width: 5),
                    Text('Filtrer', style: const TextStyle(fontSize: 11, color: AppColors.green700, fontWeight: FontWeight.w500)),
                  ]),
                ),
              ),
            ]),
          ...
          // ── Filtre zone (scrollable horizontal) ─────────────────────
          Container(
            color: AppColors.white,
                      ...
                      return Column(
                        ...
                        children: [
                          ...
                          _isGrid
                              ...
                              : Column(children: imgs.map((img) => GestureDetector(
  ...
  Widget _buildEmpty() => Center(
    child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
      ...
      const Text('Aucune image', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w500, color: AppColors.text)),
      ...
      builder: (_) => StatefulBuilder(
        builder: (ctx, setSheetState) => Padding(
          ...
          child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            const Text('STATUT', style: TextStyle(fontSize: 10, fontWeight: FontWeight.w500, color: AppColors.textMuted, letterSpacing: 0.8)),
        ...
        Image.network(image.imageUrl, fit: BoxFit.cover,
          loadingBuilder: (_, child, p) => p == null ? child
              : Container(color: AppColors.green100,
                  child: const Center(child: CircularProgressIndicator(color: AppColors.green600, strokeWidth: 1.5))),
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(color: isAlerte ? AppColors.red600.withOpacity(0.3) : AppColors.border, width: 0.5),
      ),
      child: Row(children: [
        ClipRRect(
        ...
        Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Text(image.heure, style: const TextStyle(fontSize: 11, color: AppColors.textMuted)),
